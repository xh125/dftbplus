...
module dftbp_common_unitconversion
  ...
  interface convertUnit
      module procedure convertUnitR0
      module procedure convertUnitR1
      module procedure convertUnitR2
...
contains
  ...
  subroutine convertUnitR0(units, unitName, val, status)
  ...
  end subroutine convertUnitR0


  !> Applies unit conversion to a given value
  subroutine convertUnitR1(units, unitName, val, status)
  ...
  end subroutine convertUnitR1


  !> Applies unit conversion to a given value
  subroutine convertUnitR2(units, unitName, val, status)
