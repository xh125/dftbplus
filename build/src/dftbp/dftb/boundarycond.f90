...
contains
  ...
  call errStatus%setError(-1, "Unknown boundary condition specified", "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/dftb/boundar&
      &ycond.F90", 88)
  return
    end if
  ...
  pure subroutine foldInDiatomicBlock_cplx(this, sqrBlock, iAt1, iAt2, coords, species,&
      & img2CentCell, orb)
    ...
    complex(dp), intent(inout) :: sqrBlock(:,:)
  ...
  end subroutine foldInDiatomicBlock_cplx


  !> convert matrix elements from central cell to image atoms
  pure subroutine foldOutDiatomicBlock_cplx(this, sqrBlock, iAt1, iAt2, coords, species,&
      & img2CentCell, orb)
  ...
  end subroutine foldOutDiatomicBlock_cplx


  !> convert matrix elements from image to central cell atoms
  pure subroutine foldInDiatomicBlock_real(this, sqrBlock, iAt1, iAt2, coords, species,&
      & img2CentCell, orb)
  ...
  end subroutine foldInDiatomicBlock_real


  !> convert matrix elements from central cell to image atoms
  pure subroutine foldOutDiatomicBlock_real(this, sqrBlock, iAt1, iAt2, coords, species,&
      & img2CentCell, orb)
  ...
  end subroutine foldOutDiatomicBlock_real
