...
contains
  ...
  subroutine TElStatPotentials_init(this, input, isAnExtPotential, iHamiltonianType, errStatus)
    ...
    case default
  call errStatus%setError(-1, "Unknown hamiltonian type", "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/dftb/elstatpot.F90", 114)
  return
    case(hamiltonianTypes%dftb)

    case(hamiltonianTypes%xtb)
  call errStatus%setError(-1, "Electrostatic potential plotting not currently available for xTB",&
      & "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/dftb/elstatpot.F90", 118)
  return
    end select
