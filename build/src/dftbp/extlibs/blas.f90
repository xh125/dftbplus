...
module dftbp_extlibs_blas
  ...
  interface
    ...
    subroutine ssyr2k(uplo, trans, nn, kk, alpha, aa, lda, bb, ldb, beta, cc, ldc)
      import rsp
    ...
    !> performs one of the symmetric rank 2k operations
    !> C := 0.5*alpha*(A*B**H + B**H*A)+ beta*C, or C := 0.5*alpha*(B*A**H + A**H*B)+ beta*C
    subroutine dsyr2k(uplo, trans, nn, kk, alpha, aa, lda, bb, ldb, beta, cc, ldc)
      import rdp
    ...
    !> performs one of the symmetric rank 2k operations
    !> C := 0.5*alpha*(A*B**H + B**H*A)+ beta*C, or C := 0.5*alpha*(B*A**H + A**H*B)+ beta*C
    subroutine cher2k(uplo, trans, nn, kk, alpha, aa, lda, bb, ldb, beta, cc, ldc)
      import rsp
    ...
    !> performs one of the symmetric rank 2k operations
    !> C := 0.5*alpha*(A*B**H + B**H*A)+ beta*C, or C := 0.5*alpha*(B*A**H + A**H*B)+ beta*C
    subroutine zher2k(uplo, trans, nn, kk, alpha, aa, lda, bb, ldb, beta, cc, ldc)
      import rdp
