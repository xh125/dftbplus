...
module dftbp_io_hsdutils2
  ...
  interface convertUnitHsd
      module procedure convertUnitHsdR0
      module procedure convertUnitHsdR1
      module procedure convertUnitHsdR2
...
contains
  ...
  !>
  subroutine convertUnitHsdR0(modifier, units, child, convertValue, replace, changed)
  ...
  end subroutine convertUnitHsdR0
  ...
  !> Stops by calling detailedError(), if modifier is not found among the passed units.
  !>
  subroutine convertUnitHsdR1(modifier, units, child, convertValue, replace, changed)
  ...
  end subroutine convertUnitHsdR1
  ...
  !> Stops by calling detailedError(), if modifier is not found among the passed units.
  !>
  subroutine convertUnitHsdR2(modifier, units, child, convertValue, replace, changed)
  ...
  end subroutine convertUnitHsdR2
