...
contains
  ...
  block
    ...
    write(message, "('Unexpected token ''', A, ''' found')") token%content
  call errStatus%setError(errors%syntaxError, trim(message), "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/io/indexselection.F90&
      &", 227)
  end block
  return
    end if
  ...
  call errStatus%setError(errors%syntaxError, "Missing closing parenthesis ')'", "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/i&
      &o/indexselection.F90", 306)
  return
      end if
    else
  block
  ...
  block
    character(1024) :: message
    write(message, "('Non-integer index ''', A,  '''')") selector(: seppos - 1)
  call errStatus%setError(errors%syntaxError, trim(message), "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/io/indexselection.F90&
      &", 339)
  end block
  return
  ...
  block
    character(1024) :: message
    write(message, "('Non-integer index ''', A,  '''')") selector
  call errStatus%setError(errors%syntaxError, trim(message), "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/io/indexselection.F90&
      &", 350)
  end block
  return
  ...
  block
    character(1024) :: message
    write(message, "('Out of bounds index value ', I0)") iFirst
  call errStatus%setError(errors%invalidSelector, trim(message), "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/io/indexselection&
      &.F90", 358)
  end block
  return
      end if
  ...
  block
    character(1024) :: message
    write(message, "('Out of bounds index value ', I0)") iLast
  call errStatus%setError(errors%invalidSelector, trim(message), "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/io/indexselection&
      &.F90", 364)
  end block
  return
  ...
  block
    character(1024) :: message
    write(message, "('Invalid species name ''', A, '''')") trim(selector)
  call errStatus%setError(errors%invalidSelector, trim(message), "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/io/indexselection&
      &.F90", 377)
  end block
  return
  ...
  block
    character(1024) :: message
    write(message, "('Invalid index selector ''', A, '''')") trim(selector)
  call errStatus%setError(errors%syntaxError, trim(message), "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/io/indexselection.F90&
      &", 386)
  end block
  return
