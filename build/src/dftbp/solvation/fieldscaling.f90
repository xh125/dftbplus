...
contains
  ...
  !> Scale 1 dim array of dipole moment(s) of solute. Note, these expressions are for a
  ...
  !> Scale 2 dim array of dipole moment(s) of solute. Note, these expressions are for a
  !> point dipole inside a spherical cavity.
  ...
  !> Scale 3 dim array of dipole moment(s) of solute. Note, these expressions are for a
  !> point dipole inside a spherical cavity.
  pure function scaledSoluteDipole_3(this, mu0) result (mu)
  ...
  end function scaledSoluteDipole_3
