...
contains
  ...
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 79)
  return
    end if
  ...
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 161)
  return
      end if
    else
  ...
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 167)
  return
      end if
    end if
  ...
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 186)
  return
    end if
  ...
  call errStatus%setError(-1, "Unknown TD restart format", "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart&
      &.F90", 192)
  return
      end if
  ...
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 198)
  return
      end if
  ...
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 203)
  return
      end if
  ...
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 208)
  return
      end if
  ...
  return
      ...
      if (nOrb /= size(rho, dim=1)) then
        write(error_string, "(A,I0,A,I0)")"Incorrect number of orbitals, ",nOrb,&
            & " in tddump file, should be ",size(rho, dim=1)
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 243)
  return
      end if
      if (nSpin /= size(rho, dim=3)) then
        write(error_string, "(A,I1,A,I1)")"Incorrect number of spin channels, ",nSpin,&
            & " in tddump file, should be ",size(rho, dim=3)
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 248)
  return
      end if
      if (nAtom /= size(coord, dim=2)) then
        write(error_string, "(A,I0,A,I0)")"Incorrect number of atoms, ",nAtom,&
            & " in tddump file, should be ", size(coord, dim=2)
  call errStatus%setError(-1, error_string, "/home/xh/packages/DFTB+/dftbplus-23.1/src/dftbp/timedep/dynamicsrestart.F90", 253)
  return
      end if
      if (abs(deltaT - dt) > epsilon(0.0_dp)) then
        write(error_string, "(A,E14.8,A,E14.8)")"Restart file generated for time step",&
