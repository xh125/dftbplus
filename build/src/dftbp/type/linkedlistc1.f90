...
module dftbp_type_linkedlistc1
  ...
  end type TListComplexR1


  interface init
    module procedure TListComplexR1_init
  end interface init

  interface destruct
    module procedure TListComplexR1_destruct
  end interface destruct

  interface append
    module procedure TListComplexR1_append
  end interface append

  interface len
    module procedure TListComplexR1_len
  end interface len

  interface find
    module procedure TListComplexR1_find
  end interface find

  interface hasElement
    module procedure TListComplexR1_hasElement
  end interface hasElement

  interface isUnishaped
    module procedure TListComplexR1_isUnishaped
  end interface isUnishaped

  interface get
    module procedure TListComplexR1_get
  end interface get

  interface set
    module procedure TListComplexR1_set
  end interface set

  interface asArray
    module procedure TListComplexR1_asArray
  end interface asArray

  interface intoArray
    module procedure TListComplexR1_intoArray
  end interface intoArray

  interface elemShape
    module procedure TListComplexR1_elemShape
  end interface elemShape

  interface asVector
    module procedure TListComplexR1_asVector
...
contains
  ...
  subroutine TListComplexR1_init(list)
    type(TListComplexR1), intent(inout) :: list
  ...
  end subroutine TListComplexR1_init


  !!* Destructs the list.
  !!* @param list The list to destruct.
  subroutine TListComplexR1_destruct(list)
    type(TListComplexR1), intent(inout) :: list
  ...
  end subroutine TListComplexR1_destruct


  !!* Appends an element to the list.
  !!* @param list  The list to extend.
  !!* @param data The data to add.
  subroutine TListComplexR1_append(list, data)
    type(TListComplexR1), intent(inout) :: list
  ...
  end subroutine TListComplexR1_append


  !!* Returns the length(nr. of elements) of the list
  !!* @param list The list to get the length of.
  !!* @return     Nr. of elements in the list.
  integer function TListComplexR1_len(list) result(len)
    type(TListComplexR1), intent(in) :: list

    len = list%length
  end function TListComplexR1_len
  ...
  function TListComplexR1_find(list, data) result(ind)
    integer :: ind
    type(TListComplexR1), intent(inout) :: list
    complex(dp), dimension(:), intent(in) :: data
  ...
  end function TListComplexR1_find
  ...
  logical function TListComplexR1_hasElement(list, data) result(hasElement)
    type(TListComplexR1), intent(inout) :: list
    complex(dp), dimension(:), intent(in) :: data
  ...
  end function TListComplexR1_hasElement
  ...
  subroutine TListComplexR1_get(list, data, index)
    type(TListComplexR1), intent(inout) :: list
    complex(dp), dimension(:), allocatable, intent(out) :: data
  ...
  end subroutine TListComplexR1_get
  ...
  !!* @param data The variable to put the element in.
  !!* @param index Index of the element (0 < index < length of the list)
  subroutine TListComplexR1_set(list, data, index)
    type(TListComplexR1), intent(inout) :: list
    complex(dp), dimension(:), intent(in) :: data
    integer, intent(in) :: index
  ...
  end subroutine TListComplexR1_set


  !!* Checks if list contains members with equal shaped
  !!* @param list The list object.
  !!* @return     True, if elements have equals shaped, False otherwise.
  logical function TListComplexR1_isUnishaped(list) result(isUnishaped)
    type(TListComplexR1), intent(in) :: list

    isUnishaped = list%tUnishaped
  end function TListComplexR1_isUnishaped
  ...
  subroutine TListComplexR1_asArray(list, val)
    type(TListComplexR1), intent(in) :: list
  ...
  end subroutine TListComplexR1_asArray
  ...
  subroutine TListComplexR1_elemShape(list, valshape, index)
    type(TListComplexR1), intent(inout) :: list
  ...
  end subroutine TListComplexR1_elemShape
  ...
  !!* @param index Index of the element (0 < index < length of the list)
  subroutine TListComplexR1_intoArray(list, data, nElem, index)
    type(TListComplexR1), intent(inout) :: list
  ...
  end subroutine TListComplexR1_intoArray
  ...
  !!*         and the dimensions before the last one are compatible with the
  !!*         shape of the elements in the list.
  subroutine TListComplexR1_asVector(list, val)
    type(TListComplexR1), intent(in) :: list
    complex(dp), dimension(:), intent(out) :: val
    ...
    if (ii <= lenVal) then
      val(ii:) = (0.0_dp, 0.0_dp)
    end if

  end subroutine TListComplexR1_asVector
