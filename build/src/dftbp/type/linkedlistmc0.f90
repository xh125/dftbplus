...
module dftbp_type_linkedlistmc0
  ...
  end type TListCharMc


  interface init
    module procedure TListCharMc_init
  end interface init

  interface destruct
    module procedure TListCharMc_destruct
  end interface destruct

  interface append
    module procedure TListCharMc_append
  end interface append

  interface len
    module procedure TListCharMc_len
  end interface len

  interface find
    module procedure TListCharMc_find
  end interface find

  interface hasElement
    module procedure TListCharMc_hasElement
  end interface hasElement

  interface isUnishaped
    module procedure TListCharMc_isUnishaped
  end interface isUnishaped

  interface get
    module procedure TListCharMc_get
  end interface get

  interface set
    module procedure TListCharMc_set
  end interface set

  interface asArray
    module procedure TListCharMc_asArray
...
contains
  ...
  subroutine TListCharMc_init(list)
    type(TListCharMc), intent(inout) :: list
  ...
  end subroutine TListCharMc_init


  !!* Destructs the list.
  !!* @param list The list to destruct.
  subroutine TListCharMc_destruct(list)
    type(TListCharMc), intent(inout) :: list
  ...
  end subroutine TListCharMc_destruct


  !!* Appends an element to the list.
  !!* @param list  The list to extend.
  !!* @param data The data to add.
  subroutine TListCharMc_append(list, data)
    type(TListCharMc), intent(inout) :: list
    character(mc), intent(in) :: data
  ...
  end subroutine TListCharMc_append


  !!* Returns the length(nr. of elements) of the list
  !!* @param list The list to get the length of.
  !!* @return     Nr. of elements in the list.
  integer function TListCharMc_len(list) result(len)
    type(TListCharMc), intent(in) :: list

    len = list%length
  end function TListCharMc_len
  ...
  function TListCharMc_find(list, data) result(ind)
    integer :: ind
    type(TListCharMc), intent(inout) :: list
    character(mc), intent(in) :: data
  ...
  logical function TListCharMc_hasElement(list, data) result(hasElement)
    type(TListCharMc), intent(inout) :: list
    character(mc), intent(in) :: data
  ...
  end function TListCharMc_hasElement
  ...
  subroutine TListCharMc_get(list, data, index)
    type(TListCharMc), intent(inout) :: list
    character(mc), intent(out) :: data
  ...
  end subroutine TListCharMc_get
  ...
  !!* @param data The variable to put the element in.
  !!* @param index Index of the element (0 < index < length of the list)
  subroutine TListCharMc_set(list, data, index)
    type(TListCharMc), intent(inout) :: list
    character(mc), intent(in) :: data
    integer, intent(in) :: index
  ...
  subroutine TListCharMc_asArray(list, val)
    type(TListCharMc), intent(in) :: list
    character(mc), dimension(:), intent(out) :: val
  ...
  end subroutine TListCharMc_asArray
